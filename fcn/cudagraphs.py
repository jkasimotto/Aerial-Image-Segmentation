...
def warm_up(args, criterion, optimizer, scaler, device, dataloader, rank, use_amp):
    s = torch.cuda.Stream()
...
def capture(input_shape, label_shape, device, optimizer, use_amp, model, criterion, scaler):
...
def train(args, optimizer, train_loader, rank, capture_input, capture_target, g, use_amp, scaler):
