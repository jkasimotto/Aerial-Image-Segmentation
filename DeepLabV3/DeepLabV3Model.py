...
def main():
    ...
    train_img_dir = '/home/usyd-04a/synthetic/train/images_tiled'
    train_mask_dir = '/home/usyd-04a/synthetic/train/masks_tiled/'
    ...
    save_model(model, './checkpoints/deepLabV3.pt')
